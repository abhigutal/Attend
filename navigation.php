 <nav class="navbar navbar-expand-lg navbar-light bg-dark sticky-top" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <!--        <li class="nav-item">
                    <a class="nav-link <?= (isset($page)) && $page == 'register' ? 'active' : '' ?>" href="index1.php">Register</a>
                </li>       
                <li class="nav-item">
                    <a class="nav-link <?= (isset($page)) && $page == 'login' ? 'active' : '' ?>" href="login.php">Login</a>
                </li>   -->
                <li class="nav-item">
                    <a class="nav-link <?= (isset($page)) && $page == 'logout' ? 'active' : '' ?>" href="login.php">Logout</a>
                </li>
            </ul>
        </div>
    </div>
